        ...
        <table id="myTable">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a href='editrec.php?bid=" . $row["customer_id"] . "&customer_name=" . $row["customer_name"] . "&customer_email=" . $row["customer_email"] . "&customer_phone=" . $row["customer_phone"] . "'>Edit</a>";
                    echo "</td>";
